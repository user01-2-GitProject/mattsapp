  ...
  "rawComps": [
    {
      ...
      // SECURITY: Pass API key via x-goog-api-key HTTP header rather than URL query parameter
      // to prevent credential exposure in server logs, proxy histories, and network URIs.
